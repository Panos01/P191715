#Όλος ο κώδικας είναι από αυτό το site  "https://developer.twitter.com/en/docs/labs/filtered-stream/quick-start"  που μου στείλατε στο email
...
#Με τους κωδικούς developer αντιμετώπισα πρόβλημα και δεν μπορούσα να τους φτιαξω ενώ έφτιαξα κανονικά λογαριασμό στο twitter
consumer_key = ""
consumer_secret = ""
